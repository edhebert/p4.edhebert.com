...
# What is the name of this app?
	define('APP_NAME', 'RymrTymr');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'info@edhebert.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'ehebert@fas.harvard.edu'); 

# Default DB name for this app
	define('DB_NAME', 'db27951_p4_edhebert_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'yyVR3KGk*lnJeZ(7xFVL7X)zzILJr#*FjuTqlV$p');
	define('TOKEN_SALT', 'ehE3-0pr7(0k@M^*3@6f(UldW^^W0w5)vQ%e1A9f');